...
export default class App extends React.Component {
    ...
    constructor() {
        ...
        if (components.length > 7) {
            this.state.applicationId = components[3]
            this.state.userId = components[5]
            this.state.homeId = components[7]
        } else {
    ...
    subscribeForHome() {
        ...
        fetch(webProtocol + document.location.hostname + ":" + document.location.port
            + "/v1/pss/" + this.state.applicationId
    ...
    render() {
        if(typeof this.state.dayUsageSummary != 'undefined') {
            ...
            return(
                <div>
                    <p className="PageHeader">Light Tracker</p>
